...
function setup(){
    ...
    // rotator1 = Bodies.circle(250,200,100,20,rotator_options);
    // World.add(world,rotator1);

        // rotator1 = Bodies.rectangle(250,200,100,20,
        //            rotator_options);
    // World.add(world,rotator1);


    rotator1 = Bodies.rectangle(250,200,100,20,rotator_options);
     World.add(world,rotator1);

    rotator2 = Bodies.rectangle(250,200,100,20,rotator_options);
    World.add(world,rotator1);

    rotator3 = Bodies.rectangle(250,200,100,20,rotator_options);
    World.add(world,rotator1);
